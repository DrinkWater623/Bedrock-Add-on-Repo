...
##############################################################
# For Protection
execute as @e[tag=tnt_guard] at @s run function better_tnt/check_guard
##############################################################
...
execute as @e[family=dw623_tnt,family=!vanilla,scores={bt_status=0}] run function better_tnt/check_status
##############################################################
# Dispenser Drops - check if from a dispenser
#execute as @e[family=dw623_tnt,family=dispenser,tag=!x_dispenser] run function better_tnt/check_dispenser
##############################################################
