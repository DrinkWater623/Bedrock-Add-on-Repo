...
function fetchInfoApply () {
    ...
    if ((!cmdLineSettingsJson.rp_only && bpSettings.header.min_engine_version.startsWith(keyWord)) || (!cmdLineSettingsJson.bp_only && rpSettings.header.min_engine_version.startsWith(keyWord))) {
