...
export function beforeEvents_worldInitialize () {
    ...
    world.beforeEvents.worldInitialize.subscribe((event) => {
        //ensure exists
        DynamicPropertyLib.add(world, dynamicVars.player_id, 0);
    });
}
//==============================================================================
...
export function afterEvents_playerSpawn () {
    world.afterEvents.playerSpawn.subscribe((eventData) => {
        ...
        player.setDynamicProperty(dynamicVars.isWorldOP, player.isOp());
        DynamicPropertyLib.add(player, dynamicVars.loginCount, 1);
...
function updatePlayerStats () {
    ...
    players.forEach(player => {
        ...
        if (velocity.x != 0 || velocity.y != 0 || velocity.z != 0)
            ...
            DynamicPropertyLib.add(player, dynamicVars.AFKTicks, pack.statUpdateIntervalTicks);
