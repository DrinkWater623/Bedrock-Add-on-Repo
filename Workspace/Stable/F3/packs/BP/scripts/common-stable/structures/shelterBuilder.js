...
/*
  ...
  - BlockTypeIds.normalizeBlockIdsInPlace (optional but recommended)
*/
...
/**
 * Normalize block IDs in place if BlockTypeIds.normalizeBlockIdsInPlace exists.
...
function normalizeInPlace (ids) {
    ...
    try {
        BlockTypeIds.normalizeBlockIdsInPlace(ids, { verify: false, removeEmpty: true, addNamespace: true });
    } catch {
