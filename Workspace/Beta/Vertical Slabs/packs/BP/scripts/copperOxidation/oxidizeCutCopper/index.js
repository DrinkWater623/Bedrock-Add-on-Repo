...
export const CutCopperOxidationBlockComponent = {
     ...
     */
    onRandomTick: event => {
        chatLog.log('onRandomTick', dev.debugSlabOxidationEvents);
...
function copperOxidation (block) {
    ...
    chatLog.success(`function copperOxidation(${block.typeId})`, dev.debugSlabOxidationEvents);

    const currentOxidationLevel = blockOxidationLevels[ block.typeId ];
    if (currentOxidationLevel === undefined) {
        chatLog.log(`currentOxidationLevel: undefined`, dev.debugSlabOxidationEvents);
        return;
    }
    chatLog.log(`currentOxidationLevel: ${currentOxidationLevel}`, dev.debugSlabOxidationEvents);
    ...
    for (const relativeOxidation of getRelativeOxidationLevels(
        ...
        chatLog.log(`relativeOxidation: ${relativeOxidation}`, dev.debugSlabOxidationEvents);
        if (relativeOxidation === RelativeOxidationLevel.Lower) return;
        else if (relativeOxidation === RelativeOxidationLevel.Higher) higher++;

        total++;
    }
    chatLog.log(`total: ${total} - higher: ${higher}`, dev.debugSlabOxidationEvents);
